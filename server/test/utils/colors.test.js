...
describe('colors', () => {
  const matchingTable = {
    cyan: { int: 65535, hex: '00FFFF', rgb: [0, 255, 255], hsb: [180, 100, 100], milighthue: 49 },
    violet: { int: 16711935, hex: 'FF00FF', rgb: [255, 0, 255], hsb: [300, 100, 100], milighthue: 220 },
    yellow: { int: 16776960, hex: 'FFFF00', rgb: [255, 255, 0], hsb: [60, 100, 100], milighthue: 134 },
    red: {
      int: 16711680,
      hex: 'FF0000',
      rgb: [255, 0, 0],
    ...
    lime: { int: 65280, hex: '00FF00', rgb: [0, 255, 0], xy: { x: 0, y: 1 }, hsb: [120, 100, 100], milighthue: 91 },
    blue: { int: 255, hex: '0000FF', rgb: [0, 0, 255], hsb: [240, 100, 100], milighthue: 6 },
    teal: { int: 32896, hex: '008080', rgb: [0, 128, 128], hsb: [180, 100, 50], milighthue: 49 },
    purple: { int: 8388736, hex: '800080', rgb: [128, 0, 128], hsb: [300, 100, 50], milighthue: 220 },
    olive: { int: 8421376, hex: '808000', rgb: [128, 128, 0], hsb: [60, 100, 50], milighthue: 134 },
    maroon: { int: 8388608, hex: '800000', rgb: [128, 0, 0], hsb: [0, 100, 50], milighthue: 176 },
    green: { int: 32768, hex: '008000', rgb: [0, 128, 0], hsb: [120, 100, 50], milighthue: 91 },
    navy: { int: 128, hex: '000080', rgb: [0, 0, 128], hsb: [240, 100, 50], milighthue: 6 },
    white: {
      int: 16777215,
      hex: 'FFFFFF',
      rgb: [255, 255, 255],
    ...
    gray: { int: 12632256, hex: 'C0C0C0', rgb: [192, 192, 192], milighthue: 176 },
    black: { int: 0, hex: '000000', rgb: [0, 0, 0], xy: { x: 0, y: 0 }, hsb: [0, 0, 0], milighthue: 176 },
  };

  Object.keys(matchingTable).forEach((color) => {
    const { int, hex, rgb, xy, hsb, milighthue } = matchingTable[color];
    ...
    it(`[${color}] milighthue (${rgb} -> ${milighthue})`, () => {
      const value = rgbToMilightHue(rgb);
      expect(value).to.equal(milighthue);
    });
  });
});
